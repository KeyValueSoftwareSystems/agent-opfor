...
<!-- GENERATED — source: suites/agent/eu-ai-act-bias.md — do not edit -->
...
This suite intentionally excludes the broader harmful-content evaluators that netra bundles into its full `eu-ai-act` preset; those are out of scope for the current opfor catalog.
