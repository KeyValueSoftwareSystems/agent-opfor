...
patterns:
  ...
  - name: Man-in-the-Middle (Intermediate)
    template: |-
  ...
  - name: Relay Attack (Intermediate)
    template: |-
...
<!-- GENERATED — source: evaluators/agent/inter-agent-communication.md — do not edit -->
