...
**Add an evaluator here if** the attack concerns *poisoned MCP tool descriptions, schemas, or
return values* served by the MCP server. Examples: tool-description-injection,
